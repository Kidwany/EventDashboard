...
class OrganizersController extends Controller
{
    ...
    public function index($event_id)
    {
        ...
        $users = User::with('image', 'city')
            ...
            ->whereIn('id', $requests)
            ->get();
        return view('dashboard.organizers.index', compact('users', 'event'));
    }
    ...
    public function show($event_id, $id)
    {
        ...
        return view('dashboard.organizers.show', compact('user', 'events', 'total_user_events', 'sp_experience', 'sp_doc', 'requests', 'user_payment'));
    }
