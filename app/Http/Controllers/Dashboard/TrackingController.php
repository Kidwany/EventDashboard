...
class TrackingController extends Controller
{
    ...
    public function index($event_id)
    {
        ...
        return view('dashboard.tracking.index', compact( 'event'));
    }
    public function map($event_id)
    {
        $event = Event::with('city','location')->findOrFail($event_id);
        return view('dashboard.tracking.map', compact( 'event'));
    }
