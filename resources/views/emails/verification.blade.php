        ...
        <div class="email-container">
            ...
            <div class="row approve d-flex flex-row justify-content-center">
                <div style="margin-bottom: 25px; width: 100%">
                    <p class="text-center font-weight-light main-color" style="margin: auto; font-family: 'Almarai', sans-serif;">شكرا على تسجيلك في تطبيق  <span class="app-color">همتي </span> من فضلك قم بتفعيل الحساب </p>
                </div>
            </div>
