            ...
            <ul class="dropdown-menu slideUp2">
                ...
                <li class="body">
                    <ul class="menu app_sortcut list-unstyled">
                        {{--<li>
                            <a href="{{adminUrl('car-wash/create')}}">
                                <div class="icon-circle mb-2 bg-blue"><i class="zmdi zmdi-car-wash"></i></div>
                                <p class="mb-0">مغسلة جديدة</p>
                            </a>
                        </li>
                        <li>
                            <a href="{{adminUrl('car-polish/create')}}">
                                <div class="icon-circle mb-2 bg-blue"><i class="zmdi zmdi-polymer"></i></div>
                                <p class="mb-0">تلميع جديد</p>
                            </a>
                        </li>
                        <li>
                            <a href="{{adminUrl('services/create')}}">
                                <div class="icon-circle mb-2 bg-green"><i class="zmdi zmdi-wrench"></i></div>
                                <p class="mb-0">خدمة جديدة</p>
                            </a>
                        </li>
                        <li>
