...
@section('content')
    ...
    <div class="body_scroll">
        ...
        <div class="container-fluid">
            ...
            <!-- Vertical Layout -->
            <form action="{{url('guardian-ship/'. $event->id .'/store')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
                            ...
                            <div class="body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-3">
                                        <label for="email_address">اسم الإستراحة</label>
                                        <div class="form-group">
                                            <input required type="text" name="name" value="{{old('name')}}" id="email_address" class="form-control" placeholder="ادخل اسم الإستراحة">
                                        </div>
                                    </div>

                                    <div class="col-lg-6 col-md-6">
                                        <label>المنظم</label>
                                        <select name="member_id" class="form-control show-tick ms select2" data-placeholder="اختر اعضاء الإستراحة من بين المستخدمين">
                                            @if($users)
